...
export function SpinnerIcon({ size = 14, className }) {
  const props = { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2.5, strokeLinecap: "round", "aria-hidden": true, className: className ?? "spinner-icon" };
  return (
    <svg {...props}>
