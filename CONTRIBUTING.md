...
A monorepo of 48 free, client-side web tools served at `junkyard.sh/<slug>/`.

## Repo layout

```
junkyard/
  apps/<slug>/        # 48 standalone Vite apps, one per tool
...
export const app: JunkyardApp = {
  ...
  order: 48,               // unique positive integer, 1..N across ALL apps
